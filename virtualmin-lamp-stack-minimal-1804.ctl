...
Recommends: perl-doc, bind9, libdbd-mysql-perl, quota, iptables, firewalld, clamav-base, clamav, spamc, procmail, procmail-wrapper, mariadb-server, mariadb-client, mariadb-common, awstats, proftpd, php5-mysql, jailkit, php-mysql, php-mbstring, php7.2-mysql, php7.2-mbstring, dovecot-core, dovecot-imapd, dovecot-pop3d, libsasl2-2, libsasl2-modules, sasl2-bin, unrar, p7zip, xz-utils
