...
Recommends: bind9,  libdbd-mysql-perl, quota, iptables, clamav-base, clamav, spamc, procmail, procmail-wrapper, mysql-server, mysql-client, mysql-common, awstats, webalizer, proftpd, php5-mysql, php5-mbstring, jailkit, php-mysql, php7.0-mysql, dovecot-core, dovecot-imapd, dovecot-pop3d, libsasl2-2, libsasl2-modules, sasl2-bin, unrar, p7zip, xz-utils
