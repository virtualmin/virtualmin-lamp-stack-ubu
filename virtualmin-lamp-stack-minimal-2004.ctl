...
Recommends: perl-doc, bind9, libdbd-mysql-perl, libxml-simple-perl, quota, iptables, firewalld, clamav-base, clamav, spamc, procmail, procmail-wrapper, mariadb-server, mariadb-client, mariadb-common, awstats, proftpd-basic, jailkit, php-mbstring, dovecot-core, dovecot-imapd, dovecot-pop3d, libsasl2-2, libsasl2-modules, sasl2-bin, unrar, p7zip, xz-utils, etckeeper, certbot
Suggests: postgresql, postgresql-client, libdbd-pg-perl, libpg-perl, clamav-base, clamav-daemon, clamav-freshclam, clamav-docs, clamav-testfiles, libconfig-inifiles-perl, spamassassin, postgrey, awstats, fail2ban, milter-greylist
