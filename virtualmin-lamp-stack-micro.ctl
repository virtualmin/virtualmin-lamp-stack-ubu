...
Recommends: unzip, zip, python3, libapache2-mod-fcgid, libfcgi-dev, apache2-suexec-custom, perl-doc, bind9, libdbd-mysql-perl, libxml-simple-perl, quota, iptables, firewalld, mariadb-server | mysql-server, mariadb-client | mysql-client, mariadb-common | mysql-common, awstats, jailkit, php-pear, php-cli, php-fpm, php-mysql, php-mbstring, p7zip, xz-utils, etckeeper, certbot, logrotate, lm-sensors, shared-mime-info, libauthen-oath-perl, rsync, fcgiwrap, awscli, parted, sudo
Suggests: php-cgi, postfix, postfix-pcre, procmail, procmail-wrapper, dovecot-core, dovecot-imapd, dovecot-pop3d, libsasl2-2, libsasl2-modules, sasl2-bin, postgresql, postgresql-client, libdbd-pg-perl, libpg-perl, clamav-base, clamav, clamav-daemon, clamav-freshclam, clamav-docs, clamav-testfiles, libconfig-inifiles-perl, spamassassin, spamc, postgrey, awstats, fail2ban, milter-greylist, proftpd-basic, proftpd-mod-crypto
